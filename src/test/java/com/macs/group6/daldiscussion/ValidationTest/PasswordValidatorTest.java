...
public class PasswordValidatorTest {
	...
	public static final String PASSWORD_POLICY_NOT_SATISFIED="Password Policy is not satisfied (Must contain atleast one upper case, one lowercase and one special symbol).";
